...
var (
	...
	LikePostFailed          = NewError(30013, "点赞帖子失败")
	HasLikedPost            = NewError(30014, "已经给该帖子点过赞了")
	HasNotLikedPost         = NewError(30015, "并没有给帖子点赞")
	...
	TagHasNotExisted = NewError(80005, "话题不存在")
	SameTag          = NewError(80006, "话题重复")
)
